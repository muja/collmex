...
class Collmex::Api::Cmxord-2 < Collmex::Api::Line
  def self.specification
    [
      ...
      { name: :bestaetigungstext, type: :string },
      { name: :schlusstext, type: :string },
      { name: :internes_memo, type: :string },
      { name: :teilrechnungen_erlaubt, type: :integer },
      { name: :teillieferungen_erlaubt, type: :integer },
      ...
      { name: :endgeliefert, type: :integer },
      { name: :endabgerechnet, type: :integer },
    ]
  end
end
